...
During BF, the counterfactual sits at ~1,800 USD/day — the correctly projected trend-shifted pre-BF level. Actual revenue spikes to 4,241 USD/day. The gap from 1,800 to 4,241 contains two things: the organic BF demand spike and the paid campaign contribution. The model attributes the entire gap to the campaign.
